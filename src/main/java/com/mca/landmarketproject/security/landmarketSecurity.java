...
import com.mca.landmarketproject.filter.JWTTokenValidatorFilter;
...
public class landmarketSecurity {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http.sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
				...
				.authorizeHttpRequests(auth -> auth.requestMatchers("/contact","/user/signIn","/user/signUp","/user/signInWithGoogle").permitAll().anyRequest().authenticated())
